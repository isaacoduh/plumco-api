...
const fetchCartItems = catchAsyncErrors(async (req, res) => {
  try {
...
const updateCartItemQuantity = catchAsyncErrors(async (req, res) => {
  try {
    const { userId, productId, quantity } = req.body;
...
const deleteCartItem = catchAsyncErrors(async (req, res) => {
  try {
